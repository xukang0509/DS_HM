package com.shanhai.dataStructe._15btree.test;

import com.shanhai.dataStructe._15btree.BTree;
...
public class TestBTree {
    ...
    void split1() {
        ...
        BTree.BNode root = tree.root;
        root.leaf = false;
        root.keys[0] = 5;
        root.keyNumber = 1;

        root.children[0] = new BTree.BNode(new int[]{1, 2, 3});
        root.children[0].keyNumber = 3;

        root.children[1] = new BTree.BNode(new int[]{6});
    ...
    void split2() {
        ...
        root.keys[0] = 6;
        root.keyNumber = 1;
        root.children[0] = new BTree.BNode(new int[]{1, 2, 3, 4, 5});
        root.children[0].keyNumber = 5;

        root.children[1] = new BTree.BNode(new int[]{7});
        root.children[1].keyNumber = 1;
